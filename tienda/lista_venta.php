    ...
    <section id="container">
        ...
        <table>
            <tr>
                ...
                <th class="textright"><b>Acciones</b></th>
            </tr>
            <?php
            //Paginador
            ...
            $query = mysqli_query($conection, "SELECT f.no_factura, DATE_FORMAT(f.fecha, '%d/%m/%Y') as fecha, DATE_FORMAT(f.fecha,'%H:%i:%s') as  hora, f.total_factura, f.cod_cliente, f.estatus, u.nombre AS vendedor, cl.nombre AS cliente 
                                                FROM factura f 
